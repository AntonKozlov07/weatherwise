 ...
 * GET /api/radar
 *
 * RainViewer's frame index, for the precipitation timelapse. Keyless, but routed
 * through the server like every other vendor call, which also means the frame
 * list is cached once rather than fetched per device.
 */
